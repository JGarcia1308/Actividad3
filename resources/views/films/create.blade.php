                ...
                <article class="card-body mx-auto" style="max-width: 400px;">
                    <form action="/film" method="POST">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input name="description" class="form-control" placeholder="Descripcion" type="text">
                        </div> <br><!-- form-group// -->
                        <div class="form-group input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"> <i class="fa fa-calendar"></i> </span>
                            </div>
                            <input name="release_year" class="form-control" placeholder="Año de Publicación" type="text">
                        </div> <br><!-- form-group// -->
                        ...
                        <div class="form-group input-group">
                            ...
                            <input name="length" class="form-control" placeholder="Duración" type="text">
                        </div> <br><!-- form-group// -->
                        <div class="form-group input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"> <i class="fa fa-info"></i> </span>
                            </div>
                            <input name="special_features" class="form-control" placeholder="Caracteristicas" type="text">
                        </div> <!-- form-group// -->
                        <br>
